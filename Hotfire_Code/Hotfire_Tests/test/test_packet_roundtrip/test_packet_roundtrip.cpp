...
void test_board_heartbeat_roundtrip() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_board_heartbeat_packet(hb_in, buf, sizeof(buf));
...
void test_board_heartbeat_buffer_too_small() {
    ...
    TEST_ASSERT_EQUAL(0, Diablo::create_board_heartbeat_packet(hb_in, buf, sizeof(buf)));
}
...
void test_sensor_data_roundtrip() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_sensor_data_packet(chunks, num_sensors, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_sensor_data_buffer_too_small() {
    ...
    TEST_ASSERT_EQUAL(0, Diablo::create_sensor_data_packet(chunks, 2, buf, sizeof(buf)));
}
...
void test_actuator_command_roundtrip() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_actuator_command_packet(cmds, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_actuator_command_empty_list() {
    ...
    uint8_t buf[512];
    TEST_ASSERT_EQUAL(0, Diablo::create_actuator_command_packet(cmds, buf, sizeof(buf)));
}
...
void test_pwm_actuator_roundtrip() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_pwm_actuator_packet(cmds, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_sensor_config_roundtrip_with_abort() {
    ...
    size_t n = Diablo::create_sensor_config_packet(
        ...
        controller_ip, enable_serial, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_sensor_config_roundtrip_without_abort() {
    ...
    size_t n = Diablo::create_sensor_config_packet(
        sensor_ids, ref_voltage, necessary_for_abort,
        controller_ip, 0, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_actuator_config_roundtrip() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_actuator_config_packet(1, actuators, pts, 1, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_actuator_config_no_pts() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_actuator_config_packet(0, actuators, pts, 0, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_self_test_roundtrip() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_self_test_packet(1, results, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_self_test_adc_bad() {
    ...
    uint8_t buf[512];
    size_t n = Diablo::create_self_test_packet(0, results, buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_abort_done_roundtrip() {
    uint8_t buf[64];
    size_t n = Diablo::create_abort_done_packet(buf, sizeof(buf));
    TEST_ASSERT_GREATER_THAN(0, n);
...
void test_abort_done_buffer_too_small() {
    uint8_t buf[2];
    TEST_ASSERT_EQUAL(0, Diablo::create_abort_done_packet(buf, sizeof(buf)));
}
